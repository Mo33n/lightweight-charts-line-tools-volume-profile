 ...
 */
export type BarSampleExtractor = (bar: unknown, ctx: ProfilePipelineContext) => readonly PriceLevelSample[];
/**
 * Aggregates flat samples into binned profile rows.
 * Implementations may sum, average, max, or apply custom logic.
 */
export type ProfileAggregator = (samples: readonly PriceLevelSample[], ctx: ProfilePipelineContext) => readonly ProfileRow[];
